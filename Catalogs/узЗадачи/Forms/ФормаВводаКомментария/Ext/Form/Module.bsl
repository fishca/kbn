...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		КомментарийДоИзменения = Параметры.Комментарий;
...
&НаКлиенте
Процедура ПередЗакрытиемОбработкаВопроса(Ответ, Контекст) Экспорт
...
Процедура КомандаЗакрыть(Команда)
	Если Не СокрЛП(Комментарий) = СокрЛП(КомментарийДоИзменения) Тогда
	
		ТекстСообщения = "Сохранить изменения?";
		ОписаниеОповещения = Новый ОписаниеОповещения(
			"ПередЗакрытиемОбработкаВопроса", ЭтотОбъект);
